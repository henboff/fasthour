                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name">Nome da turma<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="name" name="tur_nome" value="{{ old('name') }}" placeholder="Digite o nome da turma">
                                </div>
                            </div>
                        </div>
                        <!-- /.row -->
