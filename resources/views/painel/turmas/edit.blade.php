...
<div class="container-fluid spark-screen">
        <section class="content-header">
            <h2>
                Editar a {{ $module_name }} {{ $item->tur_nome }}
            </h2>
        </section>
        ...
        <section class="content">
            ...
            <!-- SELECT2 EXAMPLE -->
            <form action="<?php print route($route_path.'.update',$item->id_turma); ?>" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="tur_nome" value="{{ Input::old('name') ? old('name') : $item->tur_nome }}" placeholder="Digite um novo nome para a turma">
                                </div>
                            </div>
                        </div>
                        <!-- /.row -->
